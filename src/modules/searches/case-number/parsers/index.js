...
/**
 * Normalize the raw response from casestatus/submitCaseNo.
 * The response JSON has { case_data, status, div_captcha } fields.
 */
...
/**
 * Parse the case_data HTML table returned by submitCaseNo.
 * The structure is the same table format as party-name results:
 * <table id="dispTable"> with Sr No, Case Type/Case Number/Case Year,
 * Petitioner Vs Respondent, View columns.
 */
function parseCaseNumberResults(html) {
